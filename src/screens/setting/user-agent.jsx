...
const [openEd,setOpenEd]=useState(false)
  ...
  const Filter = (event) => {
    setItemUser(filter.filter(n => n.agent_name.toLowerCase().includes(event)))
  }
          ...
          <div className="panel-heading p-0">
            <div className="tab-overflow px-3">
              <ul className="nav nav-tabs nav-tabs-inverse py-1  ">
                ...
                <li className="nav-item">
                  <Link to={'/user-ag'} className="nav-link active">
            ...
            <div className="tab-pane fade active show" >
              <div className="table-responsive">
                <div className="row mb-3">
                  <div className="col-sm-9 fs-20px">ລາຍການຜູ້ໃຊ້ ຕົວແທນຂາຍປະກັນ</div>
