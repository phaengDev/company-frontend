...
export default function ReportAlmostExpire() {
                    ...
                    {currentItems.map((item, key) => (
                      <tr key={key}>
                        ...
                        <td className='text-center'>
                          {item.ext_name && (
                            <span role='button' onClick={() => handleDownload(`${url}docfile/${item.file_insurance}`)} className='text-green'> <i class="fa-solid fa-cloud-arrow-down fs-4"></i></span>
                          )}</td>
                        <td className='text-center'>
                          {user_type === 1 && (
