...
function ReportDebtCustomer() {
    const api = Config.urlApi;
    const idCustomer = localStorage.getItem('company_agent_id');
    const itemType = useTypeCust(idCustomer);
    const itemCompay = useCompanyCust(idCustomer);
                    ...
                    <div className="row mb-3">
                        ...
                        <div className="col-sm-3 mb-2">
                            ...
                            <InputGroup inside >
                                ...
                                <Input onChange={(e) => Filter(e)} placeholder='ເລກທີສັນຍາ/ສະກຸນເງິນ' />
                            </InputGroup>
...
export default ReportDebtCustomer