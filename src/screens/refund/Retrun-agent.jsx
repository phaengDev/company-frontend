...
export default function RetrunAgent() {
    ...
    <div id="content" className="app-content p-0 bg-component">
      <div class="app-content-padding px-4 py-3">
        <div class="d-lg-flex mb-lg-3 mb-2">
          <h3 class="page-header mb-0 flex-1 fs-20px">ລາຍການສັນຍາທີ່ຮັບເງິນຄຶນຈາກຕົວແທນ</h3>
      ...
      <Modal open={open} onClose={handleClose}>
        ...
        <form onSubmit={handledSubmit}>
          <Modal.Body>
            <h2 className='text-center text-red'>{numeral(values.retrun_balance).format('0,00.00')} {values.genus}</h2>
            <h3 className='text-center text-blue'>
              {numeral(values.balance_agent).format('0,00.00')} {values.genus} 
