    ...
    const optionsDonut = {
        ...
        data: [{
            ...
            dataPoints: [
                ...
                { y: balance.expences_taxes, label: "ຄອມຈ່າຍ" },
                { y: balance.incom_finally, label: "ຄອມຮັບ" },
    ...
    return (
        <div id="content" class="app-content">
            ...
            <div class="row">
                ...
                <div class="col-xl-3 col-md-6">
                    <div class="widget widget-stats bg-blue border-4 border-top border-red rounded-4">
                        <div class="stats-icon text-orange">
                            {balance.qty_almost > 0 ? (
                                <img src="./assets/img/icon/giphy.gif" width={'100%'} alt="" />
                            ) : (
                                <img src="./assets/img/icon/warning.png" width={'100%'} alt="" />
                            )}
                        </div>
                        <div class="stats-info">
