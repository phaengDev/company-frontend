...
import { SelectPicker, Input, InputGroup, DatePicker, InputPicker, Button } from 'rsuite'
        ...
        <div className="panel-body ">
          ...
          <div className="row fs-15px mb-4">
            <div className="col-sm-3 mb-2">
              ...
              <SelectPicker data={itemcn} defaultValue={inputs.company_id_fk} onChange={(e) => handelCompany('company_id_fk', e)} placeholder={'ບໍລິສັດປະກັນໄພ'} block required />
            </div>
            <div className="col-sm-3 mb-2">
            ...
            <div className="col-sm-3  mb-2">
              ...
              <SelectPicker data={itemType} defaultValue={inputs.insurance_type_fk} onChange={(e) => handleOption('insurance_type_fk', e)} placeholder={'ປະເພດປະກັນ'} block required />
            </div>
            <div className="col-sm-3  mb-2">
