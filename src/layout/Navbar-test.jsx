        ...
        <div className="menu">
          ...
          <div className={`menu-item has-sub active `}>
            <a href="javascript:;" className="menu-link ">
              <div className="menu-icon">
              <i className='fa-solid fa-indent bg-gradient-blue' />
              </div>
          ...
          <div className="menu-item has-sub">
            <a href="javascript:;" className="menu-link">
              <div className="menu-icon">
              <i class="fa-solid fa-copy bg-gradient-yellow-green"></i>
              </div>
              <div className="menu-text">ລາຍງານຄືນເງິນ</div>
              <div className="menu-caret"></div>
            </a>
            <div className="menu-submenu">
              <div className="menu-item">
              ...
              <div className="menu-item">
                <Link to={'retrun-company'} className="menu-link">
                  <div className="menu-text">ຈັດການຮັບເງິນຈາກບໍລິສັດ</div>
                </Link>
              </div>
              <div className="menu-item">
                <Link to={'retrun-agent'} className="menu-link">
                  <div className="menu-text">ຈັດການຮັບເງິນຈາກຕົວແທນ</div>
                </Link>
              </div>
              <div className="menu-item">
                <Link to={'retrun-oac'} className="menu-link">
                  <div className="menu-text">ຈັດການຮັບເງິນຈາກໂອເອຊີ</div>
                </Link>
              </div>
            </div>
          </div>
          <div className="menu-item has-sub">
            <a href="javascript:;" className="menu-link">
              <div className="menu-icon">
              <i class="fa-solid fa-wallet bg-gradient-yellow-red" />
              </div>
